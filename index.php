...
<!-- End Site Header --> 
  ...
  <div class="hero-slider flexslider clearfix" data-autoplay="yes" data-pagination="yes" data-arrows="yes" data-style="fade" data-pause="yes">
    <ul class="slides">
      ...
      <li class=" parallax" style="background-image:url(images/img2.jpg);"></li>
      <li class="parallax" style="background-image:url(images/img4.jpg);"></li>
      <li class=" parallax" style="background-image:url(images/img5.jpg);"></li>
    </ul>
  </div>
  <!-- End Hero Slider --> 
  <!-- Start Notice Bar -->
          ...
          <div class="col-md-8 col-sm-6"> 
            ...
            <div class="listing events-listing">
              <header class="listing-header">
                <h3 class=" titles">Welcome to JCS Philipines</h3>
              </header>
			  <?php
