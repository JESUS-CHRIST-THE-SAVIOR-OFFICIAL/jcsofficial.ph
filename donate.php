        ...
        <div class="row">
          <div class="col-md-9">
            <header class="single-post-header clearfix">
              <h2 class="post-title">Jesus Christ The Savior, Donation for: Music Instrument And Church Building Materials</h2>
            </header>
            <article class="post-content cause-item">
                <span class="post-meta meta-data">
                  <span><i class="fa fa-calendar"></i> 18th Dec, 2023</span>
                  <span><i class="fa fa-archive"></i> <a href="#">JCS Philipines</a>, <a href="#">Church</a></span>
                </span>
                	...
                	<div class="col-md-5">
                        <ul class="list-group">
                          <li class="list-group-item">
                            ...
                            <div class="progress">
                              <div class="progress-bar progress-bar-success" data-appear-progress-animation="0%" data-appear-animation-delay="200"></div><!-- Upto 30% use class progress-bar-danger , upto 70% use class progress-bar-warning , afterwards use class progress-bar-success -->
                            </div>
                          </li>
                      	  <li class="list-group-item"> <span class="badge">₱1,000,000</span> Amount Needed </li>
                      	  <li class="list-group-item"> <span class="badge">₱</span> Collected yet </li>
                ...
                <p>From: Jesus Christ The Savior</p>
            </article>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <p class="small short">If you would prefer to call in your donation, please call +63 930-139-4932</p>
                  </div>
                </div>
              </div>
            </div>
